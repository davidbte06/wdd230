// Fish Haven Events
const urlFishHaven = 'https://byui-cit230.github.io/weather/data/towndata.json';
...
fetch(urlFishHaven)
    ...
    .then(function (jsonSoda) {
        ...
        townFish.forEach((xFishHaven) => {
            document.getElementById('fishHaven-events').innerHTML = `${xFishHaven.events.join('<br>')}`;
...
var forecastAPI = 'https://api.openweathermap.org/data/2.5/forecast?id=5585010&exclude=minutely,hourly,alerts&units=imperial&appid=5d043ca924a4acff7edf63dee3eee10d';
...
// Fish Haven Weather Summary API
const weatherapiURL = 'https://api.openweathermap.org/data/2.5/weather?id=5585010&units=imperial&appid=5d043ca924a4acff7edf63dee3eee10d';
